...
- "Since when has @x followed me" / "when did I follow @x" are answerable via checkAccount's timestamp fields — use it rather than saying this can't be answered. If the timestamp comes back null, say plainly that Meta didn't record one for that relationship in this export, rather than guessing a date.
